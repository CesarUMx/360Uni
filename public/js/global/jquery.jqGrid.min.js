...
s=a(e).parents("*[role=dialog]").filter(":first").css("z-index");d.zIndex=s?parseInt(s,10)+2:1950}var
...
n=null,o=c.postData||f.postData;try{n=c.rowId}catch(a){}i.p&&i.p.idPrefix&&(n=a.jgrid.stripPref(i.p.idPrefix,n)),a.ajax(a.extend({url:a.isFunction(c.dataUrl)?c.dataUrl.call(i,n,d,String(c.name)):c.dataUrl,type:"POST",dataType:"html",data:a.isFunction(o)?o.call(i,n,d,String(c.name)):o,context:{elem:h,options:c,vl:d},success:function(b){var
...
g(h,c);break;case"image":case"file":h=document.createElement("input"),h.type=b,g(h,c);break;case"custom":h=document.createElement("span");try{if(typeof c.custom_element==="string")c.custom_element=window[c.custom_element];if(!a.isFunction(c.custom_element))throw"e1";var
...
e=c[0],f=a(e).attr("name");a.each(s.p.colModel,function(){if(this.editoptions&&typeof this.editoptions.custom_value==="string")this.editoptions.custom_value=window[this.editoptions.custom_value];if(this.name===f&&this.editoptions&&a.isFunction(this.editoptions.custom_value)){try{if(u[f]=this.editoptions.custom_value.call(s,a("#"+a.jgrid.jqID(f),A),"get"),void
